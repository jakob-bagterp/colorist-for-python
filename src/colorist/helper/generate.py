...
def ansi_vga_color_sequence(
    selector: AnsiVgaColorSelector, vga: VGA_ABC, ascii_escape_code: AsciiEscapeCode = AsciiEscapeCode.OCTAL
) -> str:
...
def ansi_rgb_color_sequence(
    selector: AnsiRgbColorSelector, rgb: RGB_ABC, ascii_escape_code: AsciiEscapeCode = AsciiEscapeCode.OCTAL
) -> str:
