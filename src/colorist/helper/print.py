...
from ..model.abc.oklch import OKLCH_ABC
...
def normalize_input(input: FgColor_ABC | BgColor_ABC | VGA_ABC | OKLCH_ABC | RGB_ABC | HSL_ABC | Hex_ABC | Effect_ABC | str | None) -> str:
