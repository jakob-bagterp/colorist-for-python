...
def test_full_text_background_hsl_color(
    text: str, hsl_input: tuple[float, float, float], rgb_expected: tuple[int, int, int], capfd: object
) -> None:
