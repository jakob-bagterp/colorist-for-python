...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "I want " + BgColor.RED + "red" + BgColor.OFF + " color inside this paragraph",
            "I want \033[41mred\033[0m color inside this paragraph\n",
        ),
        # String format placeholders:
        (
            f"Both {BgColor.GREEN}green{BgColor.OFF} and {BgColor.YELLOW}yellow{BgColor.OFF} are nice colors",
