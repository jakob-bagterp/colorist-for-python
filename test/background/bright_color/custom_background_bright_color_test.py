...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "I want " + BgBrightColor.RED + "red" + BgBrightColor.OFF + " color inside this paragraph",
            "I want \033[101mred\033[0m color inside this paragraph\n",
        ),
        # String format placeholders:
        (
            f"Both {BgBrightColor.GREEN}green{BgBrightColor.OFF} and {BgBrightColor.YELLOW}yellow{BgBrightColor.OFF} are nice colors",
