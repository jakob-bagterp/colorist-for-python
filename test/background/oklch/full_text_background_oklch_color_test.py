...
def test_full_text_background_oklch_color(
    text: str, oklch_input: tuple[float, float, float], rgb_expected: tuple[int, int, int], capfd: object
) -> None:
