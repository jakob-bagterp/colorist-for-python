...
@pytest.mark.parametrize("lightness, chroma, hue, expected", [
    ...
    (0.599, 0.0, 0.0, (127, 127, 127)),  # Mid-grey where lightness 0.599 is the Oklab/OKLCH value for roughly 50% sRGB.
    (0.628, 0.2577, 29.23, (255, 0, 0)),  # Pure red in sRGB and verified OKLCH coordinates for Hex value #FF0000.
    (0.86644, 0.29483, 142.5, (0, 255, 0)),  # Pure green in sRGB and verified OKLCH coordinates for Hex value #00FF00.
