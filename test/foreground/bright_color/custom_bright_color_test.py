...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "I want " + BrightColor.RED + "red" + BrightColor.OFF + " color inside this paragraph",
            "I want \033[91mred\033[0m color inside this paragraph\n",
        ),
        # String format placeholders:
        (
            f"Both {BrightColor.GREEN}green{BrightColor.OFF} and {BrightColor.YELLOW}yellow{BrightColor.OFF} are nice colors",
