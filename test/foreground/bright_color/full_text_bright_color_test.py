...
def test_bright_green_full_text_color(capfd: object) -> None:
    text = "This is GREEN!"
    bright_green(text)
...
def test_bright_yellow_full_text_color(capfd: object) -> None:
    text = "This is YELLOW!"
    bright_yellow(text)
    terminal_output = terminal.get_output(capfd)
...
def test_bright_red_full_text_color(capfd: object) -> None:
    text = "This is RED!"
    bright_red(text)
    terminal_output = terminal.get_output(capfd)
...
def test_bright_magenta_full_text_color(capfd: object) -> None:
...
def test_bright_blue_full_text_color(capfd: object) -> None:
    text = "This is BLUE!"
    bright_blue(text)
    terminal_output = terminal.get_output(capfd)
...
def test_bright_cyan_full_text_color(capfd: object) -> None:
    text = "This is CYAN!"
    bright_cyan(text)
    terminal_output = terminal.get_output(capfd)
...
def test_bright_white_full_text_color(capfd: object) -> None:
    text = "This is WHITE!"
    bright_white(text)
    terminal_output = terminal.get_output(capfd)
...
def test_bright_black_full_text_color(capfd: object) -> None:
    text = "This is BLACK!"
    bright_black(text)
    terminal_output = terminal.get_output(capfd)
