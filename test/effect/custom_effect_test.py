...
MIXED_PARAMETERS_MOCK_TEXT = (
    "I want both \033[31mcolored and \033[5mblinking\033[25m text\033[0m inside this paragraph\n"
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            f"Only effect for this {Effect.UNDERLINE}word{Effect.UNDERLINE_OFF}.",
            "Only effect for this \033[4mword\033[24m.\n",
        ),
        (f"Only effect for this {Effect.BLINK}word{Effect.BLINK_OFF}.", "Only effect for this \033[5mword\033[25m.\n"),
        (
            f"Only effect for this {Effect.REVERSE}word{Effect.REVERSE_OFF}.",
            "Only effect for this \033[7mword\033[27m.\n",
        ),
