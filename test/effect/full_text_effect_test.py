...
from colorist import (Color, effect_blink, effect_bold, effect_dim,
                      effect_hide, effect_reverse, effect_underline)


def test_bold_full_text_effect(capfd: object) -> None:
    text = "This is BOLD!"
    effect_bold(text)
...
def test_dim_full_text_effect(capfd: object) -> None:
    text = "This is DIMMED!"
    effect_dim(text)
    terminal_output = terminal.get_output(capfd)
...
def test_underline_full_text_effect(capfd: object) -> None:
...
def test_blink_full_text_effect(capfd: object) -> None:
...
def test_reverse_full_text_effect(capfd: object) -> None:
...
def test_hide_full_text_effect(capfd: object) -> None:
    text = "This is HIDDEN!"
    effect_hide(text)
    terminal_output = terminal.get_output(capfd)
...
def test_blink_full_text_effect_with_color(capfd: object) -> None:
    text = "This is BLINKING!"
